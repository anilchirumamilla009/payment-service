...
CREATE TABLE IF NOT EXISTS silos (
    ...
    default_credit_limit   DECIMAL(19,2)  DEFAULT 0,
    default_profit_share   DECIMAL(5,4)   DEFAULT 0,
    type                   VARCHAR(30)
);
...
-- Beneficial owners (shared by bank-accounts & customer-accounts)
CREATE TABLE IF NOT EXISTS beneficial_owners (
    id           BIGINT       AUTO_INCREMENT PRIMARY KEY,
    account_id   UUID         NOT NULL,
    account_type VARCHAR(30)  NOT NULL,  -- BANK_ACCOUNT or CUSTOMER_ACCOUNT
    owner_id     UUID         NOT NULL,
    owner_type   VARCHAR(30)  NOT NULL   -- PERSON or CORPORATION
);
