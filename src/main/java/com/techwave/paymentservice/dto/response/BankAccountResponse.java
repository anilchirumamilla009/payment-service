...
public class BankAccountResponse {
    ...
    public BankAccountResponse(UUID id, String beneficiary, String beneficiaryAddress, String nickname,
                              String iban, String bic, String accountNumber, String nationalBankCode,
                              String nationalBranchCode, String nationalClearingCode,
                              String currency, String country) {
        this.id = id;
        this.resourceType = "bank-accounts";
