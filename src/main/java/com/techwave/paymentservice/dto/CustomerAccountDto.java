...
/**
 * DTO representing a customer account,
 * matching the OpenAPI CustomerAccount schema.
 */
public class CustomerAccountDto {

    private UUID id;
    private String resourceType = "customer-accounts";
    private String name;
    ...
    public void setAccountCreationTime(
            OffsetDateTime accountCreationTime) {
